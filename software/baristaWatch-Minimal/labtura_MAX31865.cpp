/***************************************************
  This is a library for the PT100/P1000 RTD Sensor w/MAX31865

  Written by Frowin Ellermann (labtura.com)
...
/**************************************************************************/
//
labtura_MAX31865::labtura_MAX31865(int8_t spi_cs, int8_t spi_mosi,
...
*/
/**************************************************************************/
labtura_MAX31865::labtura_MAX31865(int8_t spi_cs)
...
*/
/**************************************************************************/
bool labtura_MAX31865::begin(max31865_numwires_t wires) {
  spi_dev.begin();
...
*/
/**************************************************************************/
uint8_t labtura_MAX31865::readFault(void) {
...
*/
/**************************************************************************/
void labtura_MAX31865::clearFault(void) {
...
*/
/**************************************************************************/
void labtura_MAX31865::enableBias(bool b) {
  uint8_t t = readRegister8(MAX31865_CONFIG_REG);
  if (b) {
...
*/
/**************************************************************************/
void labtura_MAX31865::autoConvert(bool b) {
  uint8_t t = readRegister8(MAX31865_CONFIG_REG);
  if (b) {
...
void labtura_MAX31865::enable50Hz(bool b) {
  uint8_t t = readRegister8(MAX31865_CONFIG_REG);
  if (b) {
...
*/
/**************************************************************************/
void labtura_MAX31865::setWires(max31865_numwires_t wires) {
  uint8_t t = readRegister8(MAX31865_CONFIG_REG);
...
*/
/**************************************************************************/
float labtura_MAX31865::temperature(float RTDnominal, float refResistor) {
  float Z1, Z2, Z3, Z4, Rt, temp;

  if( !_readRTD_bia && !_readRTD_req ){
    readRTD_bia();
    _readRTD_bia = true;
    _readRTD_millis = millis();
    return 0;
  }

  if( _readRTD_bia && !_readRTD_req && ( (millis()-_readRTD_millis) > 10 ) ){
    readRTD_req();
    _readRTD_req = true;
    _readRTD_millis = millis();
    return 0;
  ...
  if( _readRTD_bia &&  _readRTD_req && ( (millis()-_readRTD_millis) > 65 ) ){
...
*/
/**************************************************************************/
uint16_t labtura_MAX31865::readRTD_bia(void) {
  clearFault();
  enableBias(true);
}

uint16_t labtura_MAX31865::readRTD_req(void) {
  //delay(10);
  uint8_t t = readRegister8(MAX31865_CONFIG_REG);
...
uint16_t labtura_MAX31865::readRTD_ans(void) {
  //delay(65);
...
uint8_t labtura_MAX31865::readRegister8(uint8_t addr) {
  uint8_t ret = 0;
...
uint16_t labtura_MAX31865::readRegister16(uint8_t addr) {
...
void labtura_MAX31865::readRegisterN(uint8_t addr, uint8_t buffer[],
                                      uint8_t n) {
...
void labtura_MAX31865::writeRegister8(uint8_t addr, uint8_t data) {
